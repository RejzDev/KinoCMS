                ...
                <form action="{{route('pages.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" placeholder="Название страници">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <img src="{{ Storage::disk('public')->url('catalog/page/source/no-img.jpg') }}" alt="" class="img-lg">
