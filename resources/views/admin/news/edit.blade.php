                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <img src="{{ Storage::disk('public')->url('catalog/news/source/' . $news['image']) }}"
                                     alt=""
                                     class="img-lg">
                        ...
                        <div class="form-group">
                            ...
                            @php
                                ...
                                if ($img) {
                                    ...
                                    $url['img'][$i] = Storage::disk('public')->url('catalog/news/source/' . $img['patch']);
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="url-video" id="url-video"
                                   placeholder="Сылка на видео" value="{{$news['url_video']}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="url" value="{{$news['url']}}" id="url"
                                   placeholder="url">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" name="seo-description" id="seo-description"
                                      placeholder="description">{{$news['seo_description']}}</textarea>
                        </div>
                    </div>
                    <!-- /.card-body -->
